...
class RefMessage(Base, TimestampMixin):
    ...
    btn_en: Mapped[str] = mapped_column(String())
    btn_ua: Mapped[str] = mapped_column(String())
    btn_ru: Mapped[str] = mapped_column(String())
    answer_en: Mapped[str] = mapped_column(String())
    answer_ua: Mapped[str] = mapped_column(String())
    answer_ru: Mapped[str] = mapped_column(String())
